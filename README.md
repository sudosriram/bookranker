...
No libraries, no fluff — just logic, fast search, and a ton of learning baked in. I could’ve built it out fully with a UI like I did in my **CryptWarden** C project, but this one was all about testing myself with OOP and writing DRY, maintainable code.
